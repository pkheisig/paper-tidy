...
class PaperLogic:
    def __init__(self):
        self.headers = {'User-Agent': 'Paperenamer/1.0 (mailto:user@example.com)'}
...
class PaperenamerApp(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Paperenamer")
    ...
    def create_widgets(self):
        ...
        ttk.Label(header_frame, text="Paperenamer", font=('Segoe UI', 12, 'bold')).pack(side='left')
